...
class UrlencodeHandler(WebHandler):
    def get(self):
        ...
        self.template_params['page_urlencoded'] = urllib.quote_plus('%stools/urlencode' % self.template_params['base_url'])
        ...
        self.render_template(os.path.join('tools', 'urlencode', 'index.html'))